/*	 __ ___  __
	...
	Le copyright précédent et cette autorisation doivent étre distribués dans toute
	copie entiére ou substantielle de ce Programme.
	...
	un but particulier et l'absence de contrefaéon. En aucun cas les auteurs ou
	ayants droit ne seront tenus responsables de réclamations, dommages ou autres,
	que ce soit dans une action de nature contractuelle, préjudiciable ou autres faéons,
	découlant de, hors ou en connexion avec le Programme ou l'utilisation ou autres
	modifications du Programme.
*/
/**
	\file uart.c
	\brief Gére la communication bidirectionelle avec le port série
	...
	\author Iouri Savard Colbert
	\date 20 septembre 2024 - Modification pour utiliser la nouvelle version de fifo qui supporte différents types
*/
