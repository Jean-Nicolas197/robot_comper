...
/**
	\file uart.h
	\brief Gère la communication bidirectionnelle avec le port série
	\author Iouri Savard Colbert
	\date 13 Mars 2012 - Date de création
	\date 16 Septembre 2012 - Ajout du support de UART 1
	\date 24 janvier 2020 - Nettoyage pour le projet
	\date 10 octobre 2024 - Ajout de fonctions pour gérer les float
*/
